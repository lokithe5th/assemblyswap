...
contract DEX {
    ...
    function price(
        ...
        uint256 inputAmountWithFeee = xInput * 997;
        uint256 numerator = inputAmountWithFeee * yReserves;
        uint256 denominator = xReserves * 1000 + xInput;
    ...
    function ethToToken() public payable returns (uint256 tokenOutput) {
        ...
        uint256 tokensBought = price(msg.value, address(this).balance - msg.value, token.balanceOf(address(this)));
    ...
    function tokenToEth(uint256 tokenInput) public returns (uint256 ethOutput) {
        ...
        require(success && token.transferFrom(msg.sender, address(this), tokenInput));
        return ethBought;
    ...
    function withdraw(uint256 amount) public returns (uint256 ethAmount, uint256 tokenAmount) {
        ...
        require(success && token.transfer(msg.sender, tokenAmount));
